...
class deflicker_Dataset(data.Dataset):
    def __init__(self, opt):
        super(deflicker_Dataset, self).__init__()
    ...
    def degrade_img(self, opt, img, degrade_en, np_state):
    ...
    def __getitem__(self, index):
        ...
        degrade_en["grey_en"] = np.random.uniform() < self.opt.get("grey_en", 0.05)
